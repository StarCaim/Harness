...
export default function Vehicles() {
  return (
    <>
      ...
      <div id="terms" className="text-rose text-center bg-black text-2xl p-10">

      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p className="text-robin-egg-blue">Welcome to Cyber Automotive Rides!</p>

      <p className="text-robin-egg-blue">
        These terms and conditions outline the rules and regulations for the use
        of Cyber Automotive Rides's Website, located at cyberautomotivecars.com.
      </p>

      <p className="text-robin-egg-blue">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Cyber Automotive Rides if you do not agree
      ...
      <p className="text-robin-egg-blue">
        We employ the use of cookies. By accessing Cyber Automotive Rides, you agreed
        to use cookies in agreement with the Cyber Automotive Rides's Privacy Policy.
      </p>
      ...
      <p className="text-robin-egg-blue">
        Unless otherwise stated, Cyber Automotive Rides and/or its licensors own the
        intellectual property rights for all material on Cyber Automotive Rides. All
        intellectual property rights are reserved. You may access this from
        Cyber Automotive Rides for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p className="text-rose">You must not:</p>
      <ul>
        <li>Republish material from Cyber Automotive Rides</li>
        <li>Sell, rent or sub-license material from Cyber Automotive Rides</li>
        <li>Reproduce, duplicate or copy material from Cyber Automotive Rides</li>
        <li>Redistribute content from Cyber Automotive Rides</li>
      </ul>
      ...
      <p className="text-robin-egg-blue">
        ...
        exchange opinions and information in certain areas of the website. Cyber
        Automotive does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Cyber Automotive Rides,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Cyber Automotive Rides
      ...
      <p className="text-robin-egg-blue">
        Cyber Automotive Rides reserves the right to monitor all Comments and to
        remove any Comments which can be considered inappropriate, offensive or
        causes breach of these Terms and Conditions.
      </p>

      <p className="text-rose">You warrant and represent that:</p>
      ...
      <p className="text-robin-egg-blue">
        You hereby grant Cyber Automotive Rides a non-exclusive license to use,
      ...
      <p className="text-robin-egg-blue">
        ...
        the hyperlink compensates the absence of Cyber Automotive Rides; and (d) the
      ...
      <p className="text-robin-egg-blue">
        ...
        e-mail to Cyber Automotive Rides. Please include your name, your organization
      ...
      <p className="text-robin-egg-blue">Approved organizations may hyperlink to our Website as follows:</p>
      ...
      <p className="text-robin-egg-blue">
        No use of Cyber Automotive Rides's logo or other artwork will be allowed for
      ...
      <p className="text-robin-egg-blue">Please read Privacy Policy</p>
