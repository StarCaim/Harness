...
import CarBanner from "public/peakpx.jpg";
import CarBannerPhone from "public/pxfuel.jpg";
    ...
    <>
      ...
      <nav className=" bg-oxford-blue overflow-hidden">
        ...
        >
          <div className=" mx-auto">
            <Link href="/" className="cybr-btn w-2 m-auto cybr-btn-active">
              Home<span>_</span>
      ...
      <main className="">
        <section className="">
          <Image
            src={CarBanner}
            className=" hidden h-screen max-w-screen md:block"
          />
          <Image
            src={CarBannerPhone}
            className=" h-screen w-screen md:hidden"
          />
          <div className=" text-center content-center bg-indigo-dye py-5 xl:py-0">
            <div className="xl:absolute w-full -bottom-96 xl:flex">
              <Link
                href="/vehicles"
                className="block cb-btn font-oxta border-robin-egg-blue border-4 py-5 mx-auto my-5 bg-oxford-blue text-white w-5/6 xl:w-1/4 text-lg transition-colors duration-300 hover:bg-rose-dark hover:border-rose"
              >
                INVENTORY
              </Link>
              <Link
