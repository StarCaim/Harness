...
function setFeatured(target) {
  ...
  item.setAttribute("class", "item carousel-item");
  item.appendChild(cardContainer);

  cardContainer.setAttribute("class", "col-md-3");
  ...
  photoLink.setAttribute(
    "href",
    `./vehicle.html#${target.make} ${target.model}`
  );
...
function activate() {
  let active = document.querySelector("div.carousel-item");
  active.setAttribute("class", "item carousel-item active");
